    ...
    <header className="bg-white/80 backdrop-blur">
      <div className="w-full mx-auto flex items-center justify-between px-4 py-3">
        ...
        <nav className="hidden sm:flex items-center gap-6">
          ...
          <Link
            href="/cart"
            className="relative rounded-full p-[10px] text-lg hover:bg-slate-100"
          >
            <ShoppingCart size={20} color="gray" />
            <span className="absolute top-[-10px] right-[-5px] flex justify-center items-center w-[25px] h-[25px] rounded-full bg-black text-white text-sm font-medium">
              {storage['total']?.itemCount ?? 0}
            </span>
          </Link>
        </nav>
